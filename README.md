...
<div align="left">
  <a href="https://github.com/cyberpunk92">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1200&color=7057FF&width=750&lines=Hello+World+%F0%9F%91%8B+Python+Engineer;Computer+Vision+%26+Deep+Learning+Researcher;Medical+Imaging+%C2%B7+3D+Brain+MRI+%26+Dermoscopy;Learning+in+Computer+Vision" alt="Typing SVG" />
  </a>
</div>

# Mohsin Ali
### Computer Vision & Deep Learning Researcher · Software Engineering @ UET Taxila
...
### 🔬 Featured Computer Vision & Machine Learning Repositories

| Project | Highlights & Tech Stack |
| :--- | :--- |
| **[3d-brain-mri-monai](https://github.com/cyberpunk92/3d-brain-mri-monai)** | Volumetric 3D MRI brain segmentation and preprocessing pipeline using **MONAI**, **PyTorch**, and **NiBabel/SimpleITK** for neuroimaging data. |
| **[skin-lesion-project](https://github.com/cyberpunk92/skin-lesion-project)** | Multi-model benchmarking on dermatoscopic images evaluating **ConvNeXt**, **Swin Transformer**, and **EfficientNet** with **PyTorch** and **Albumentations**. |
| **[skin-lesion-gradcam-pytorch](https://github.com/cyberpunk92/skin-lesion-gradcam-pytorch)** | Explainable AI (XAI) diagnostic tool generating **Grad-CAM** and **Grad-CAM++** heatmaps to visualize feature attribution and clinical regions of interest. |
| **[Practical-Machine-Learning](https://github.com/cyberpunk92/Practical-Machine-Learning)** | Supervised and unsupervised ML workflows featuring feature engineering, model tuning, and ensemble methods (**Scikit-Learn**, **XGBoost**, **LightGBM**). |
